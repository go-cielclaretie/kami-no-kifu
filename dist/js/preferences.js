...
(function (root) {
  ...
  function clean(input) {
    ...
    const out = {}, base = K.defaults(), source = { ...input };
    if (!Object.prototype.hasOwnProperty.call(source, 'infoVariant')) {
      const legacy = source.infoDirection === 'vertical' ? source.infoVariantVertical : source.infoVariantHorizontal;
      if (legacy) source.infoVariant = legacy;
    }
    for (const key of Object.keys(base)) if (Object.prototype.hasOwnProperty.call(source, key)) {
      const v = source[key];
